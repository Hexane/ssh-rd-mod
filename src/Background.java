...
public class Background implements Runnable {
	...
	{	
		...
		String ibssName = String.format("iBSS.n90ap.RELEASE.dfu", device.getAp());
		...
		if (null != dict.objectForKey("ios5")) {
			String ibecName = String.format("iBEC.n90ap.RELEASE.dfu", device.getAp());
		...
		if (!device.isWtfStub()) {
			String deviceTreeName =  String.format("DeviceTree.n90ap.img3", device.getAp());
		
			String deviceTreePath = String.format("Firmware/all_flash/all_flash.n90ap.production/DeviceTree.n90ap.img3", device.getAp(), deviceTreeName);
			...
			String manifestPath = String.format("Firmware/all_flash/all_flash.n90ap.production/manifest", device.getAp());
			...
			String kernelName1 = String.format("kernelcache.release.n90", device.getAp());
			
			String kernelPath = String.format("kernelcache.release.n90", device.getAp(), kernelName1);
			
			String kernelFile = downloadAndProcessFile(kernelPath);
			...
			gui.trace("Kernel prepared at %s", kernelPath);
			
			
			
			String ramdiskName1 = String.format("038-5512-003.dmg", device.getAp());
			
			String ramdiskPath = String.format("038-5512-003.dmg", device.getAp(), ramdiskName1);
			
			String ramdiskFile1 = downloadAndProcessFile(ramdiskPath);
			
			if (ramdiskFile1 == null) {
			...
			gui.trace("Ramdisk prepared at %s", ramdiskFile1);
